...
class BehAV_Planner(Node):
    ...
    def solve_mpc(self, intermediate_goal_pose):
        ...
        try:
            ...
            return ref_cmd_vel # 如果无解，回退到 nlopt 建议
    ...
    def sim_trajectory(self, r, delta, theta, vMax, time_horizon):
        ...
        # ==========================================
        #  修改：使用 self.goal_factor 来控制是否考虑目标距离
        # ==========================================
        expected_progress = self.goal_factor * (2 * total_distance + 1 * total_heading_error)
        ...
        # Sum the costs
        total_cost = expected_collision + expected_progress + expected_action + self.behav_weight * expected_behav
