...
class LandmarkDetectorNode(Node):
    def __init__(self):
        ...
        # ========= 固定配置：不从外部接收任务信息 =========
        self.api_key = "sk-04c50afd503a4a108b0112f3184ea921"   # 在这里填你的 DashScope API Key
        # self.vlm_model = "qwen3.5-plus"
        # self.vlm_model = "qwen3-vl-plus"
        self.vlm_model = "qwen3.5-flash"
    ...
    def draw_detection_overlay(self, image_rgb, x, y):
        vis = image_rgb.copy()
    ...
    def process_image(self, image_bgr):
        ...
        circled_img_rgb = self.draw_detection_overlay(image_rgb, x, y)
